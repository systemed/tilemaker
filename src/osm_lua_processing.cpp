...
OsmLuaProcessing::OsmLuaProcessing(
	...
	luaState["OSM"].setClass(kaguya::UserdataMetatable<OsmLuaProcessing>()
		...
		.addFunction("HasTags", &OsmLuaProcessing::HasTags)
		...
		.addFunction("SetTag", &OsmLuaProcessing::SetTag)
